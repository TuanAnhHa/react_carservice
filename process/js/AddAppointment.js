        ...
        <div className="panel-body" style={ displayAptBody }>
          <form className="add-appointment form-horizontal" onSubmit={ this.handleAdd }>
            <div className="form-group">
              <label className="col-sm-2 control-label" htmlFor="carName">Car Brand</label>
              <div className="col-sm-10">
                <input type="text" className="form-control"
                  id="carName" ref="inputCarName" placeholder="Brand" />
              </div>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              <div className="col-sm-offset-2 col-sm-10">
                  <button type="button" className="btn btn-danger pull-left" onClick={ this.toggleAptDisplay }>Cancel</button>
